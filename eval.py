...
testloader = torch.utils.data.DataLoader(testset, batch_size=batch_sizes, shuffle=False, num_workers=0, collate_fn=testset.collate_fn)
...
def eval():
    ...
    annotation_path='E:/数据集/pascal/VOC2012/Annotations/%s.xml'
    imagesetfile='E:/数据集/pascal/VOC2012/ImageSets/Main/%s_test.txt'
